...
public abstract class ActionBase {
    ...
    protected int toNumber(String srtNumber) {
        int number = 0;
        try {
            number = Integer.parseInt(srtNumber);
        } catch (Exception e) {
    ...
    /**
     * リクエストパラメータから引数で指定したパラメータ名を値を返却する
     * @param key パラメータ名
     * @return パラメータの値
     */
